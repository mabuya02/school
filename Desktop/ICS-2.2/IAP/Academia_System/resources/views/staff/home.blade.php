 ...
 <!--  Staff Functionalities
  ...
  3. View News for Department. -->
   ...
   <head>
      ...
      <!-- site metas -->
      <title>Academia Online - Staff Homepage</title>
                  ...
                  <div class="carousel-item active">
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div><img src="images/home5.jpg" class="image_1"></div>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div id="data" class="product_section layout_padding">
         <div class="container">
            ...
            <div class="product_section_2">
               ...
               <td style="text-align: left;
                  padding: 8px;"><a href="{{ url('delete_message1',$messages->id) }}" class="btn btn-primary px-4 mx-auto mb-4" onclick="return confirm('Are You Sure You Want To Delete This Message ?')">Delete Message</a></td>
                </tr>
                </tr>
                @endforeach
                </table>

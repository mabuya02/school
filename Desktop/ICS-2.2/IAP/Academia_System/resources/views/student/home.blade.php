...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  5. View Course, Graduation, Resources, & Timetable. -->
   ...
   <head>
      ...
      <!-- site metas -->
      <title>Academia Online - Student Homepage</title>
                  ...
                  <div class="carousel-item active">
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div><img src="images/home3.jpg" class="image_1"></div>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <br>
                    <div class="col-md-6">
                        <div class="email_text">
                                  <h6 class="conect_text">Register for a Course</h6>
                                                 <form action="{{ url('reg_course') }}" method="post" enctype="multipart/form-data">
          @csrf
                                <div class="form-group">
                                    <input type="text" class="email-bt" placeholder="Student ID" required="required" name="uid" id="uid"/>
                                </div>
                                <div class="form-group">
                  ...
                  <br>
                                     <div class="col-md-6">
                                        <div class="email_text">
                                                  <h6 class="conect_text">Register for Graduation</h6>
